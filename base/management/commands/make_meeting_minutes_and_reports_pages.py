...
from group.models import (
    ...
    GroupMeetingMinutesPage,
    GroupPage,
    GroupReportsIndexPage,
    GroupReportsPage,
)
from intranetunits.models import (
    IntranetUnitsPage,
    IntranetUnitsReportsIndexPage,
    IntranetUnitsReportsPage,
)
...
try:
    from library_website.settings import DIRECTORY_PASSWORD, DIRECTORY_USERNAME
except ImportError:
    import os
    ...
    def handle(self, *args, **options):
        ...
        if "/groups/" in kwargs["path"]:
            ...
            try:
                ...
                group_meeting_minutes_page = (
                    GroupMeetingMinutesPage.objects.descendant_of(group_page).get()
                )
            except:  # noqa: E722
                return "The group page could not be found."

            if (
                GroupMeetingMinutesIndexPage.objects.descendant_of(group_page).count()
                == 0
            ):
                ...
                group_meeting_minutes_index_page = (
                    GroupMeetingMinutesIndexPage.objects.create(
        ...
        # DEPARTMENT PAGES
            ...
            if (
                IntranetUnitsReportsIndexPage.objects.child_of(department_page).count()
                == 0
            ):
                ...
                department_reports_index_page = (
                    IntranetUnitsReportsIndexPage.objects.create(
                ...
                # move 2016 into "Reports".
                department_reports_page.move(
                    department_reports_index_page, "first-child"
                )
