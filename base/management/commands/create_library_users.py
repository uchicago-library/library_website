...
class Command(BaseCommand):
    ...
    def _format_output(self, new_users, existing_users):
        ...
        new_user_string = (
            "The following new users were created in the system:%s \n" % pretty_bar
        )
        existing_user_string = (
            "The following existing user accounts were updated:%s \n" % pretty_bar
        )
        outlier_user_string = (
            "The following users are renegades in the system:%s \n" % pretty_bar
        )
