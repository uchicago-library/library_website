...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-ia', '--is_active', 
            action='store', 
            nargs=1,
    ...
    def handle(self, *args, **options):
        ...
        try:
            kwargs = { 'username': options['username'][0], 
        ...
        try: 
            ...
            self.stdout.write('Either the "%s" or "%s" group doesn\'t exist.' % (self.REQUIRED_GROUP_NAMES[1], self.REQUIRED_GROUP_NAMES[2]))
            self.stdout.write('Make sure both of these groups have been created and try running the command again.')
            sys.exit(1)
        ...
        try:
            ...
            kwargs['is_active'] = True if options['is_active'][0] == 'True' or options['is_active'][0] == 'T' else False
        except:
            pass 
