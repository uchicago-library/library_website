...
from group.models import GroupMeetingMinutesPage, GroupPage, GroupReportsPage
...
).objects.get(model="groupmeetingminutespage", app_label="group")
group_reports_content_type = apps.get_model("contenttypes.ContentType").objects.get(
    model="groupreportspage", app_label="group"
)
intranet_units_reports_content_type = apps.get_model(
    "contenttypes.ContentType"
).objects.get(model="intranetunitsreportspage", app_label="intranetunits")
