...
from ask_a_librarian.utils import (
    get_chat_status,
    get_chat_status_and_css,
    get_chat_status_css,
    get_unit_chat_link,
)
from base.utils import (
    get_building_hours_and_lid,
    get_hours_and_location,
    get_json_hours_by_id,
)
            ...
            return JsonResponse(
                {
                    ...
                    "current_hours": get_json_hours_by_id(
                        int(libcalid), all_building_hours
                    ),
                    "llid": libcalid,
        ...
        return JsonResponse(
            {
                "events": flatten_events(
                    get_events(
                        UC_EVENTS_FEED, ttrss_url, n, n + relativedelta(years=1), False
                    )
                )
            }
        )
