    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.Page')),
                ('last_reviewed', models.DateField(blank=True, null=True, verbose_name='Last Reviewed')),
                ('excerpt', wagtail.core.fields.RichTextField(blank=True, help_text='Shown on the News feed. Populated automatically from “Body” if left empty.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', wagtail.core.fields.RichTextField(help_text='Text to include in emails. This can include internal or external links.')),
