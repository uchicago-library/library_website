    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_library_expert_fallback', wagtail.core.fields.StreamField((('person', wagtail.core.blocks.StructBlock((('library_expert', wagtail.core.blocks.PageChooserBlock(help_text='Select a staff page from Loop/Staff', required=False)), ('libguides', wagtail.core.blocks.ListBlock(wagtail.core.blocks.StructBlock((('link_text', wagtail.core.blocks.CharBlock(max_length=255, required=False)), ('link_external', wagtail.core.blocks.URLBlock(required=False)), ('link_page', wagtail.core.blocks.PageChooserBlock(required=False)))), icon='link'))), icon='view', required=False, template='public/blocks/featured_library_expert.html')),), default=[])),
                ('featured_library_experts', wagtail.core.fields.StreamField((('person', wagtail.core.blocks.StructBlock((('library_expert', wagtail.core.blocks.PageChooserBlock(help_text='Select a staff page from Loop/Staff', required=False)), ('libguides', wagtail.core.blocks.ListBlock(wagtail.core.blocks.StructBlock((('link_text', wagtail.core.blocks.CharBlock(max_length=255, required=False)), ('link_external', wagtail.core.blocks.URLBlock(required=False)), ('link_page', wagtail.core.blocks.PageChooserBlock(required=False)))), icon='link')), ('start_date', wagtail.core.blocks.DateBlock(blank=True, null=True)), ('end_date', wagtail.core.blocks.DateBlock(blank=True, null=True))), icon='view', required=False, template='public/blocks/featured_library_expert.html')),), default=[])),
