# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-20 22:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_specialist', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fancypages_fancypage_content_specialist', to='staff.StaffPage')),
                ('editor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fancypages_fancypage_editor', to='staff.StaffPage')),
                ('page_maintainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fancypages_fancypage_maintainer', to='staff.StaffPage')),
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fancypages_fancypage_related', to='units.UnitPage')),
            ],
            options={
                'abstract': False,
            },
