    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('stacks_range', models.CharField(blank=True, max_length=100)),
                ('stacks_URL', models.URLField(blank=True, default='', max_length=254)),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='alternate_name', to='lib_collections.CollectionPage')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='collection_subject_placements', to='lib_collections.CollectionPage')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collection_pages', to='subjects.Subject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('donor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='donor_page', to='public.DonorPage')),
                ('parent', modelcluster.fields.ParentalKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='donor_page_list_placement', to='lib_collections.CollectionPage')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('collection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='highlighted_collections', to='lib_collections.CollectionPage')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('collection_name', models.CharField(blank=True, max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('parent', modelcluster.fields.ParentalKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='related_collection_placement', to='lib_collections.CollectionPage')),
                ('related_collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='related_collection', to='lib_collections.CollectionPage')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('parent', modelcluster.fields.ParentalKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subject_specialist_placement', to='lib_collections.CollectingAreaPage')),
                ('subject_specialist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subject_specialist', to='staff.StaffPage')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='regional_collections', to='lib_collections.CollectingAreaPage'),
        ),
        migrations.AddField(
            model_name='highlightedcollectionsplacement',
            name='parent',
            field=modelcluster.fields.ParentalKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='highlighted_collection_placements', to='lib_collections.CollectingAreaPage'),
        ),
        migrations.AddField(
            model_name='collectionpageformatplacement',
            name='format',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='lib_collections.Format'),
        ),
        migrations.AddField(
            model_name='collectionpageformatplacement',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='collection_placements', to='lib_collections.CollectionPage'),
        ),
        migrations.AddField(
            model_name='collectingareareferencelocationplacement',
            name='parent',
            field=modelcluster.fields.ParentalKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reference_location_placements', to='lib_collections.CollectingAreaPage'),
        ),
        migrations.AddField(
            model_name='collectingareareferencelocationplacement',
            name='related_collection',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reference_location', to='public.LocationPage'),
        ),
        migrations.AddField(
            model_name='collectingareapagestacksranges',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='stacks_ranges', to='lib_collections.CollectingAreaPage'),
        ),
        migrations.AddField(
            model_name='collectingareapagelibguides',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='lib_guides', to='lib_collections.CollectingAreaPage'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectingareapage',
            name='subject',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lib_collections_collectingareapage_related', to='subjects.Subject'),
        ),
        migrations.AddField(
            model_name='collectingareapage',
            name='unit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exhibit_pages', to='subjects.Subject')),
            ],
            options={
                'verbose_name': 'Subject Placement',
                'verbose_name_plural': 'Subbject Placements',
