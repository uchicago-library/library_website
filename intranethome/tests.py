...
class test_mail_aliases_view(SimpleTestCase):
    ...
    def test_format_splitting(self):
        ...
        self.assertEqual(format_splitting(option1_triangle_brackets),
                         {'triangle_brackets': ['I am triangle', 'i_am_triangle@uchicago.edu', option1_triangle_brackets]})
        self.assertEqual(format_splitting(option2_parentheses),
                         {'parentheses': ['I am parentheses', 'i_am_parentheses@uchicago.edu', option2_parentheses]})
        self.assertEqual(format_splitting(option3_plain_email), 
